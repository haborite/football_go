...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ln,depthTest:!1,depthWrite:!1})}function Ha(){return new Nn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Yo(),fragmentShader:`
		...
		`,blending:Ln,depthTest:!1,depthWrite:!1})}function Va(){return new Nn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Yo(),fragmentShader:`
	...
	`}function Xf(i){let t=new WeakMap,e=null;function n(a){if(a&&a.isTexture){const c=a.mapping,l=c===Zr||c===Jr,h=c===wi||c===Ri;if(l||h){let u=t.get(a);const f=u!==void 0?u.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==f)return e===null&&(e=new za(i)),u=l?e.fromEquirectangular(a,u):e.fromCubemap(a,u),u.texture.pmremVersion=a.pmremVersion,t.set(a,u),u.texture;if(u!==void 0)return u.texture;{const m=a.image;return l&&m&&m.height>0||h&&m&&s(m)?(e===null&&(e=new za(i)),u=l?e.fromEquirectangular(a):e.fromCubemap(a),u.texture.pmremVersion=a.pmremVersion,t.set(a,u),a.addEventListener("dispose",r),u.texture):null}}}return a}function s(a){let c=0;const l=6;for(let h=0;h<l;h++)a[h]!==void 0&&c++;return c===l}function r(a){const c=a.target;c.removeEventListener("dispose",r);const l=t.get(c);l!==void 0&&(t.delete(c),l.dispose())}function o(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:o}}function qf(i){const t={};function e(n){if(t[n]!==void 0)return t[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return t[n]=s,s}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const s=e(n);return s===null&&Os("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function Yf(i,t,e,n){const s={},r=new WeakMap;function o(u){const f=u.target;f.index!==null&&t.remove(f.index);for(const _ in f.attributes)t.remove(f.attributes[_]);for(const _ in f.morphAttributes){const M=f.morphAttributes[_];for(let p=0,d=M.length;p<d;p++)t.remove(M[p])}f.removeEventListener("dispose",o),delete s[f.id];const m=r.get(f);m&&(t.remove(m),r.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,e.memory.geometries--}function a(u,f){return s[f.id]===!0||(f.addEventListener("dispose",o),s[f.id]=!0,e.memory.geometries++),f}function c(u){const f=u.attributes;for(const _ in f)t.update(f[_],i.ARRAY_BUFFER);const m=u.morphAttributes;for(const _ in m){const M=m[_];for(let p=0,d=M.length;p<d;p++)t.update(M[p],i.ARRAY_BUFFER)}}function l(u){const f=[],m=u.index,_=u.attributes.position;let M=0;if(m!==null){const T=m.array;M=m.version;for(let y=0,b=T.length;y<b;y+=3){const B=T[y+0],C=T[y+1],A=T[y+2];f.push(B,C,C,A,A,B)}}else if(_!==void 0){const T=_.array;M=_.version;for(let y=0,b=T.length/3-1;y<b;y+=3){const B=y+0,C=y+1,A=y+2;f.push(B,C,C,A,A,B)}}else return;const p=new(Gc(f)?qc:Xc)(f,1);p.version=M;const d=r.get(u);d&&t.remove(d),r.set(u,p)}function h(u){const f=r.get(u);if(f){const m=u.index;m!==null&&f.version<m.version&&l(u)}else l(u);return r.get(u)}return{get:a,update:c,getWireframeAttribute:h}}function $f(i,t,e){let n;function s(f){n=f}let r,o;function a(f){r=f.type,o=f.bytesPerElement}function c(f,m){i.drawElements(n,m,r,f*o),e.update(m,n,1)}function l(f,m,_){_!==0&&(i.drawElementsInstanced(n,m,r,f*o,_),e.update(m,n,_))}function h(f,m,_){if(_===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,m,0,r,f,0,_);let p=0;for(let d=0;d<_;d++)p+=m[d];e.update(p,n,1)}function u(f,m,_,M){if(_===0)return;const p=t.get("WEBGL_multi_draw");if(p===null)for(let d=0;d<f.length;d++)l(f[d]/o,m[d],M[d]);else{p.multiDrawElementsInstancedWEBGL(n,m,0,r,f,0,M,0,_);let d=0;for(let T=0;T<_;T++)d+=m[T];for(let T=0;T<M.length;T++)e.update(d,n,M[T])}}this.setMode=s,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function Kf(i){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(e.calls++,o){case i.TRIANGLES:e.triangles+=a*(r/3);break;case i.LINES:e.lines+=a*(r/2);break;case i.LINE_STRIP:e.lines+=a*(r-1);break;case i.LINE_LOOP:e.lines+=a*r;break;case i.POINTS:e.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function s(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:s,update:n}}function jf(i,t,e){const n=new WeakMap,s=new oe;function r(o,a,c){const l=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=h!==void 0?h.length:0;let f=n.get(a);if(f===void 0||f.count!==u){let et=function(){A.dispose(),n.delete(a),a.removeEventListener("dispose",et)};f!==void 0&&f.texture.dispose();const m=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,M=a.morphAttributes.color!==void 0,p=a.morphAttributes.position||[],d=a.morphAttributes.normal||[],T=a.morphAttributes.color||[];let y=0;m===!0&&(y=1),_===!0&&(y=2),M===!0&&(y=3);let b=a.attributes.position.count*y,B=1;b>t.maxTextureSize&&(B=Math.ceil(b/t.maxTextureSize),b=t.maxTextureSize);const C=new Float32Array(b*B*4*u),A=new Vc(C,b,B,u);A.type=mn,A.needsUpdate=!0;const O=y*4;for(let g=0;g<u;g++){const S=p[g],V=d[g],z=T[g],W=b*B*4*g;for(let j=0;j<S.count;j++){const k=j*O;m===!0&&(s.fromBufferAttribute(S,j),C[W+k+0]=s.x,C[W+k+1]=s.y,C[W+k+2]=s.z,C[W+k+3]=0),_===!0&&(s.fromBufferAttribute(V,j),C[W+k+4]=s.x,C[W+k+5]=s.y,C[W+k+6]=s.z,C[W+k+7]=0),M===!0&&(s.fromBufferAttribute(z,j),C[W+k+8]=s.x,C[W+k+9]=s.y,C[W+k+10]=s.z,C[W+k+11]=z.itemSize===4?s.w:1)}}f={count:u,texture:A,size:new It(b,B)},n.set(a,f),a.addEventListener("dispose",et)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",o.morphTexture,e);else{let m=0;for(let M=0;M<l.length;M++)m+=l[M];const _=a.morphTargetsRelative?1:1-m;c.getUniforms().setValue(i,"morphTargetBaseInfluence",_),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",f.texture,e),c.getUniforms().setValue(i,"morphTargetsTextureSize",f.size)}return{update:r}}function Zf(i,t,e,n){let s=new WeakMap;function r(c){const l=n.render.frame,h=c.geometry,u=t.get(c,h);if(s.get(u)!==l&&(t.update(u),s.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),s.get(c)!==l&&(e.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,i.ARRAY_BUFFER),s.set(c,l))),c.isSkinnedMesh){const f=c.skeleton;s.get(f)!==l&&(f.update(),s.set(f,l))}return u}function o(){s=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),e.remove(l.instanceMatrix),l.instanceColor!==null&&e.remove(l.instanceColor)}return{update:r,dispose:o}}class Jc extends Le{constructor(t,e,n,s,r,o,a,c,l,h=Ti){if(h!==Ti&&h!==Pi)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===Ti&&(n=Jn),n===void 0&&h===Pi&&(n=Ci),super(null,s,r,o,a,c,h,n,l),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=a!==void 0?a:Ve,this.minFilter=c!==void 0?c:Ve,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const Qc=new Le,Wa=new Jc(1,1),tl=new Vc,el=new Fh,nl=new Kc,Xa=[],qa=[],Ya=new Float32Array(16),$a=new Float32Array(9),Ka=new Float32Array(4);function Ii(i,t,e){const n=i[0];if(n<=0||n>0)return i;const s=t*e;let r=Xa[s];if(r===void 0&&(r=new Float32Array(s),Xa[s]=r),t!==0){n.toArray(r,0);for(let o=1,a=0;o!==t;++o)a+=e,i[o].toArray(r,a)}return r}function ue(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function de(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function Js(i,t){let e=qa[t];e===void 0&&(e=new Int32Array(t),qa[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function Jf(i,t){const e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function Qf(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ue(e,t))return;i.uniform2fv(this.addr,t),de(e,t)}}function tp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(ue(e,t))return;i.uniform3fv(this.addr,t),de(e,t)}}function ep(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ue(e,t))return;i.uniform4fv(this.addr,t),de(e,t)}}function np(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(ue(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),de(e,t)}else{if(ue(e,n))return;Ka.set(n),i.uniformMatrix2fv(this.addr,!1,Ka),de(e,n)}}function ip(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(ue(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),de(e,t)}else{if(ue(e,n))return;$a.set(n),i.uniformMatrix3fv(this.addr,!1,$a),de(e,n)}}function sp(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(ue(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),de(e,t)}else{if(ue(e,n))return;Ya.set(n),i.uniformMatrix4fv(this.addr,!1,Ya),de(e,n)}}function rp(i,t){const e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function op(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ue(e,t))return;i.uniform2iv(this.addr,t),de(e,t)}}function ap(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ue(e,t))return;i.uniform3iv(this.addr,t),de(e,t)}}function cp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ue(e,t))return;i.uniform4iv(this.addr,t),de(e,t)}}function lp(i,t){const e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function hp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ue(e,t))return;i.uniform2uiv(this.addr,t),de(e,t)}}function up(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ue(e,t))return;i.uniform3uiv(this.addr,t),de(e,t)}}function dp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ue(e,t))return;i.uniform4uiv(this.addr,t),de(e,t)}}function fp(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(Wa.compareFunction=zc,r=Wa):r=Qc,e.setTexture2D(t||r,s)}function pp(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture3D(t||el,s)}function mp(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTextureCube(t||nl,s)}function gp(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture2DArray(t||tl,s)}function _p(i){switch(i){case 5126:return Jf;case 35664:return Qf;case 35665:return tp;case 35666:return ep;case 35674:return np;case 35675:return ip;case 35676:return sp;case 5124:case 35670:return rp;case 35667:case 35671:return op;case 35668:case 35672:return ap;case 35669:case 35673:return cp;case 5125:return lp;case 36294:return hp;case 36295:return up;case 36296:return dp;case 35678:case 36198:case 36298:case 36306:case 35682:return fp;case 35679:case 36299:case 36307:return pp;case 35680:case 36300:case 36308:case 36293:return mp;case 36289:case 36303:case 36311:case 36292:return gp}}function vp(i,t){i.uniform1fv(this.addr,t)}function xp(i,t){const e=Ii(t,this.size,2);i.uniform2fv(this.addr,e)}function Mp(i,t){const e=Ii(t,this.size,3);i.uniform3fv(this.addr,e)}function Sp(i,t){const e=Ii(t,this.size,4);i.uniform4fv(this.addr,e)}function yp(i,t){const e=Ii(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function Ep(i,t){const e=Ii(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function Tp(i,t){const e=Ii(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function bp(i,t){i.uniform1iv(this.addr,t)}function Ap(i,t){i.uniform2iv(this.addr,t)}function wp(i,t){i.uniform3iv(this.addr,t)}function Rp(i,t){i.uniform4iv(this.addr,t)}function Cp(i,t){i.uniform1uiv(this.addr,t)}function Pp(i,t){i.uniform2uiv(this.addr,t)}function Lp(i,t){i.uniform3uiv(this.addr,t)}function Dp(i,t){i.uniform4uiv(this.addr,t)}function Up(i,t,e){const n=this.cache,s=t.length,r=Js(e,s);ue(n,r)||(i.uniform1iv(this.addr,r),de(n,r));for(let o=0;o!==s;++o)e.setTexture2D(t[o]||Qc,r[o])}function Ip(i,t,e){const n=this.cache,s=t.length,r=Js(e,s);ue(n,r)||(i.uniform1iv(this.addr,r),de(n,r));for(let o=0;o!==s;++o)e.setTexture3D(t[o]||el,r[o])}function Np(i,t,e){const n=this.cache,s=t.length,r=Js(e,s);ue(n,r)||(i.uniform1iv(this.addr,r),de(n,r));for(let o=0;o!==s;++o)e.setTextureCube(t[o]||nl,r[o])}function Fp(i,t,e){const n=this.cache,s=t.length,r=Js(e,s);ue(n,r)||(i.uniform1iv(this.addr,r),de(n,r));for(let o=0;o!==s;++o)e.setTexture2DArray(t[o]||tl,r[o])}function Op(i){switch(i){case 5126:return vp;case 35664:return xp;case 35665:return Mp;case 35666:return Sp;case 35674:return yp;case 35675:return Ep;case 35676:return Tp;case 5124:case 35670:return bp;case 35667:case 35671:return Ap;case 35668:case 35672:return wp;case 35669:case 35673:return Rp;case 5125:return Cp;case 36294:return Pp;case 36295:return Lp;case 36296:return Dp;case 35678:case 36198:case 36298:case 36306:case 35682:return Up;case 35679:case 36299:case 36307:return Ip;case 35680:case 36300:case 36308:case 36293:return Np;case 36289:case 36303:case 36311:case 36292:return Fp}}class Bp{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=_p(e.type)}}class kp{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=Op(e.type)}}class zp{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const s=this.seq;for(let r=0,o=s.length;r!==o;++r){const a=s[r];a.setValue(t,e[a.id],n)}}}const Pr=/(\w+)(\])?(\[|\.)?/g;function ja(i,t){i.seq.push(t),i.map[t.id]=t}function Gp(i,t,e){const n=i.name,s=n.length;for(Pr.lastIndex=0;;){const r=Pr.exec(n),o=Pr.lastIndex;let a=r[1];const c=r[2]==="]",l=r[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===s){ja(e,l===void 0?new Bp(a,i,t):new kp(a,i,t));break}else{let u=e.map[a];u===void 0&&(u=new zp(a),ja(e,u)),e=u}}}class Bs{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=t.getActiveUniform(e,s),o=t.getUniformLocation(e,r.name);Gp(r,o,this)}}setValue(t,e,n,s){const r=this.map[e];r!==void 0&&r.setValue(t,n,s)}setOptional(t,e,n){const s=e[n];s!==void 0&&this.setValue(t,n,s)}static upload(t,e,n,s){for(let r=0,o=e.length;r!==o;++r){const a=e[r],c=n[a.id];c.needsUpdate!==!1&&a.setValue(t,c.value,s)}}static seqWithValue(t,e){const n=[];for(let s=0,r=t.length;s!==r;++s){const o=t[s];o.id in e&&n.push(o)}return n}}function Za(i,t,e){const n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}const Hp=37297;let Vp=0;function Wp(i,t){const e=i.split(`
...
`+Wp(i.getShaderSource(t),o)}else return s}function qp(i,t){const e=Xp(t);return`vec4 ${i}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function Yp(i,t){let e;switch(t){case Yl:e="Linear";break;case $l:e="Reinhard";break;case Kl:e="Cineon";break;case jl:e="ACESFilmic";break;case Jl:e="AgX";break;case Ql:e="Neutral";break;case Zl:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const Es=new D;function $p(){Kt.getLuminanceCoefficients(Es);const i=Es.x.toFixed(4),t=Es.y.toFixed(4),e=Es.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function Zp(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(t,s),o=r.name;let a=1;r.type===i.FLOAT_MAT2&&(a=2),r.type===i.FLOAT_MAT3&&(a=3),r.type===i.FLOAT_MAT4&&(a=4),e[o]={type:r.type,location:i.getAttribLocation(t,o),locationSize:a}}return e}function Hi(i){return i!==""}function Qa(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function tc(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const Jp=/^[ \t]*#include +<([\w\d./]+)>/gm;function Co(i){return i.replace(Jp,tm)}const Qp=new Map;function tm(i,t){let e=Dt[t];if(e===void 0){const n=Qp.get(t);if(n!==void 0)e=Dt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return Co(e)}const em=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function ec(i){return i.replace(em,nm)}function nm(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function nc(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}function im(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Ac?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===Al?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===dn&&(t="SHADOWMAP_TYPE_VSM"),t}function sm(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case wi:case Ri:t="ENVMAP_TYPE_CUBE";break;case $s:t="ENVMAP_TYPE_CUBE_UV";break}return t}function rm(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Ri:t="ENVMAP_MODE_REFRACTION";break}return t}function om(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case wc:t="ENVMAP_BLENDING_MULTIPLY";break;case Xl:t="ENVMAP_BLENDING_MIX";break;case ql:t="ENVMAP_BLENDING_ADD";break}return t}function am(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function cm(i,t,e,n){const s=i.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const c=im(e),l=sm(e),h=rm(e),u=om(e),f=am(e),m=Kp(e),_=jp(r),M=s.createProgram();let p,d,T=e.glslVersion?"#version "+e.glslVersion+`
...
void main() {
  ...
  </defs></svg>`}function Me(i,t,e={}){const n=i[0].toFixed(1),s=i[1].toFixed(1),r=t==="b"?"tg-black":"tg-white",o=t==="b"?"#000":"#8a8a80";let a=`<g${e.faded?' opacity="0.35"':""}>`;if(a+=`<circle cx="${n}" cy="${s}" r="12.5" fill="url(#${r})" stroke="${o}" stroke-width="1"/>`,e.num!==void 0){const c=t==="b"?"#fff":"#222";a+=`<text x="${n}" y="${(i[1]+4.5).toFixed(1)}" text-anchor="middle" font-size="13" font-weight="bold" fill="${c}">${e.num}</text>`}return a+"</g>"}function ks(i,t="#e0452f"){return`<circle cx="${i[0].toFixed(1)}" cy="${i[1].toFixed(1)}" r="16" fill="none" stroke="${t}" stroke-width="2.5" stroke-dasharray="4 3"/>`}function Tc(i){return ks(i,"#ffd76e")+`<text x="${i[0].toFixed(1)}" y="${(i[1]+4).toFixed(1)}" text-anchor="middle" font-size="12" font-weight="bold" fill="#ffd76e">目</text>`}function vi(i,t=""){return`<g${t?` transform="${t}"`:""}><use href="#tg-board"/>${i}</g>`}function Ls(i,t,e,n="#c8cede"){return`<text x="${i}" y="${t}" text-anchor="middle" font-size="16" font-weight="bold" fill="${n}">${e}</text>`}const Rg='<polygon points="294,114 320,114 320,103 346,126 320,149 320,138 294,138" fill="#ffd76e"/>';function Cg(){const i='<svg class="tut-img" viewBox="0 0 280 260">'+vi(Me(ne[0],"b",{num:1})+Me(pe[2],"w",{num:2})+Me(Oe[4],"b",{num:3})+ks(ne[3],"#ffd76e"))+"</svg>",t='<svg class="tut-img wide" viewBox="0 0 640 300">'+vi(Me(ne[0],"b")+Me(ne[1],"w")+Me(ne[4],"w")+ks(pe[0]),"translate(8,6) scale(0.92)")+vi(Me(ne[1],"w")+Me(ne[4],"w")+Me(pe[0],"w")+ks(pe[0])+Me(ne[0],"b",{faded:!0})+`<path d="M${(ne[0][0]-9).toFixed(1)},${(ne[0][1]-9).toFixed(1)}l18,18m0,-18l-18,18" stroke="#e0452f" stroke-width="4" stroke-linecap="round"/>`,"translate(366,6) scale(0.92)")+Rg+Ls(137,282,"黒の「呼吸点」は のこり1つ！")+Ls(495,282,"白に置かれると…取られて消える！")+"</svg>",e=[ne[0],ne[3],ne[4],pe[0],pe[3],pe[4],Be[3],Oe[4],Be[4]],n=[ne[1],ne[2],pe[1],pe[2],Be[0],Oe[1],Be[1],Oe[2]],s='<svg class="tut-img" viewBox="0 0 280 260">'+vi(e.map(c=>Me(c,"b")).join("")+n.map(c=>Me(c,"w")).join(""))+"</svg>",r=[ne[1],ne[3],ne[4],pe[0],pe[1],pe[2],pe[4],Oe[1],Be[1],Oe[4],Be[4]],o=[pe[3],Oe[0],Be[0],Oe[2],Be[2],Oe[3],Be[3]],a='<svg class="tut-img wide" viewBox="0 0 640 300">'+vi([...r,ne[0],ne[2]].map(c=>Me(c,"b")).join("")+o.map(c=>Me(c,"w")).join("")+'<path d="M95,83l90,90m0,-90l-90,90" stroke="#e0452f" stroke-width="8" stroke-linecap="round" opacity="0.85"/>',"translate(8,6) scale(0.92)")+vi(r.map(c=>Me(c,"b")).join("")+o.map(c=>Me(c,"w")).join("")+Tc(ne[0])+Tc(ne[2]),"translate(366,6) scale(0.92)")+Ls(137,282,"埋めすぎ → まるごと取られる！","#ff8c7a")+Ls(495,282,"空き点2つ → 絶対に取られない！","#ffd76e")+"</svg>";return[{title:"線の交わる点に、交代で置く",svg:i,body:"サッカーボール型の碁盤です。黒と白が、<strong>線の交わる点</strong>（全部で60か所）に<strong>交代で</strong>石を置いていきます。黒が先です。黄色の印のように、<strong>空いている点ならどこでもOK</strong>。一度置いた石は動かせません。"},{title:"囲むと取れる",svg:t,body:"石から線でつながった<strong>となりの空き点</strong>が、その石の「<strong>いき</strong>」です。呼吸点を相手に<strong>全部ふさがれる</strong>と、石は取られて盤から消えます。くっついている味方の石どうしは、ひとつのかたまりとして同じ運命になります。"},{title:"多いほうが勝ち",svg:s,body:"置きたい場所がなくなったら「パス」。<strong>二人が続けてパス</strong>すると試合終了です。<strong>盤の上に石が多いほう</strong>の勝ち！（例：黒31子・白29子なら黒の2目勝ち）"},{title:"ヒント：埋めすぎに注意！",svg:a,body:"自分の陣地を<strong>すき間なく埋めつくすのは危険</strong>。最後にまるごと囲まれて、全部取られてしまいます。陣地の中に<strong>はなれた空き点を2つ</strong>残しておけば、相手はどちらの空き点にも置けない（置いたとたんに自分が囲まれてしまう手は禁止）ので、その石たちは<strong>絶対に取られません</strong>。"}]}function Pg(i){const t=m=>document.getElementById(m),e=t("overlay-tutorial"),n=t("overlay-welcome"),s=t("tut-slides"),r=t("tut-dots"),o=t("btn-tut-prev"),a=t("btn-tut-next"),c=Cg();s.insertAdjacentHTML("beforebegin",wg()),s.innerHTML=c.map((m,_)=>`<section class="tut-slide${_===0?"":" hidden"}">
        <h3>${_+1}. ${m.title}</h3>
        ${m.svg}
        <p>${m.body}</p>
      </section>`).join(""),r.innerHTML=c.map((m,_)=>`<button class="tut-dot" data-i="${_}"></button>`).join("");let l=0;function h(){s.querySelectorAll(".tut-slide").forEach((m,_)=>{m.classList.toggle("hidden",_!==l)}),r.querySelectorAll(".tut-dot").forEach((m,_)=>{m.classList.toggle("on",_===l)}),o.disabled=l===0,a.textContent=l===c.length-1?"さっそく対局へ！":"次へ →"}function u(){localStorage.setItem(zr,"1"),l=0,h(),e.classList.remove("hidden")}function f(){e.classList.add("hidden")}o.addEventListener("click",()=>{l>0&&(l--,h())}),a.addEventListener("click",()=>{l<c.length-1?(l++,h()):f()}),r.addEventListener("click",m=>{const _=m.target.closest(".tut-dot");_&&(l=Number(_.dataset.i),h())}),t("btn-tut-close").addEventListener("click",f),t("btn-tutorial").addEventListener("click",u),document.addEventListener("keydown",m=>{if(!e.classList.contains("hidden")){if(m.key==="Escape")f();else if(m.key==="ArrowLeft"&&l>0)l--,h();else if(m.key==="ArrowRight"&&l<c.length-1)l++,h();else return;m.preventDefault()}}),t("btn-welcome-yes").addEventListener("click",()=>{n.classList.add("hidden"),u()}),t("btn-welcome-no").addEventListener("click",()=>{localStorage.setItem(zr,"1"),n.classList.add("hidden")}),i.firstVisitPrompt&&localStorage.getItem(zr)===null&&n.classList.remove("hidden")}const ct=i=>document.getElementById(i);let w=null,tn=null;function Ze(i){return i===Se?"黒":"白"}function ll(i){switch(i){case"occupied":return"そこにはすでに石があります";case"suicide":return"ここには置けません：自滅手になるため（自滅禁止点）";case"superko":return"ここには置けません：過去と同じ盤面に戻るため（同形反復の禁止）";case"gameover":return"対局はすでに終了しています"}}let Gr;function ce(i,t=3e3){const e=ct("toast");e.textContent=i,e.classList.remove("hidden"),Gr!==void 0&&clearTimeout(Gr),Gr=window.setTimeout(()=>e.classList.add("hidden"),t)}function ta(i){ct("screen-title").classList.toggle("hidden",i!=="title"),ct("screen-game").classList.toggle("hidden",i!=="game"),i==="title"&&ct("overlay-result").classList.add("hidden")}function Ys(){return!w||w.kind==="replay"?!1:!w.game.over&&w.game.turn===w.myColor}function Lg(){tn||(tn=new Mg(ct("board-container"),ct("inset-frame"),{onPointClick:Ug,ghostColor:()=>!w||w.kind==="replay"||!Ys()||w.kind==="npc"&&w.thinking||w.kind==="online"&&w.ended?0:w.myColor,canPlay:i=>w!==null&&w.game.tryPlace(i).ok}))}function ze(){if(!w||!tn)return;const i=w.game,t=w.kind==="replay";tn.updateState(i.board,i.lastMovePoint());const e=i.score();if(ct("count-black").textContent=String(e.black),ct("count-white").textContent=String(e.white),ct("komi-label").textContent=`（＋コミ ${i.komi}）`,ct("replay-controls").classList.toggle("hidden",!t),ct("btn-pass").classList.toggle("hidden",t),ct("btn-undo").classList.toggle("hidden",t),ct("btn-resign").classList.toggle("hidden",t),ct("undo-line").classList.toggle("hidden",t),!t){const o=w.kind==="online"?w.undoCounts:i.undoCounts;ct("undo-line").textContent=`待った：黒 ${o[Se]}回 ／ 白 ${o[sn]}回`}const n=ct("status-line");if(w.kind==="replay"){const o=w.moves.length;w.cursor===o?i.over?n.textContent=e.byResign!==void 0?`終局：${e.winner==="black"?"黒":"白"}の中押し勝ち（${Ze(e.byResign)}の投了）`:e.winner==="draw"?"終局：持碁（引き分け）":`終局：${e.winner==="black"?"黒":"白"}の${Math.abs(e.margin)}目勝ち`:n.textContent="棋譜の最後（未終局）":n.textContent=`第${w.cursor}手まで再生（次は${Ze(i.turn)}）`,ct("rp-counter").textContent=`${w.cursor} / ${o} 手`,ct("btn-rp-first").disabled=w.cursor===0,ct("btn-rp-prev").disabled=w.cursor===0,ct("btn-rp-next").disabled=w.cursor===o,ct("btn-rp-last").disabled=w.cursor===o;return}if(i.over)n.textContent="終局";else if(w.kind==="online"&&w.ended)n.textContent="相手が退出しました";else if(w.kind==="npc"&&w.thinking)n.textContent=`NPC（${Ze(i.turn)}）思考中…`;else if(Ys())n.textContent=`あなたの番です（${Ze(w.myColor)}）`;else{const o=w.kind==="npc"?"NPC":"相手";n.textContent=`${o}の番です（${Ze(i.turn)}）`}const s=!i.over&&!(w.kind==="npc"&&w.thinking)&&!(w.kind==="online"&&w.ended);ct("btn-pass").disabled=!s||!Ys();const r=i.moveLog.some(o=>o.by===w.myColor);ct("btn-undo").disabled=!s||!r,ct("btn-resign").disabled=i.over||w.kind==="online"&&w.ended,i.over&&Dg()}function Dg(){if(!w||w.kind==="replay")return;const i=w.game,t=i.score(),e=w.kind==="online"?w.undoCounts:i.undoCounts;let n;if(t.winner==="draw")n="引き分け（持碁）";else{const a=t.winner==="black"?Se:sn,c=a===w.myColor,l=t.byResign!==void 0?"中押し勝ち":"勝ち";n=`${Ze(a)}の${l} — あなたの${c?"勝ちです！":"負けです"}`}ct("result-winner").textContent=n;const s=t.winner==="draw"||t.byResign!==void 0?t.byResign!==void 0?`<div>（${Ze(t.byResign)}の投了による終局）</div>`:"":`<div>（${Math.abs(t.margin)} 目差）</div>`;ct("result-detail").innerHTML=`<div>黒：盤上 ${t.black} 子</div><div>白：盤上 ${t.white} 子 ＋ コミ ${t.komi} ＝ ${t.whiteTotal}</div>`+s,ct("result-undo").textContent=`待った：黒 ${e[Se]}回 ／ 白 ${e[sn]}回`,ct("btn-rematch").classList.toggle("hidden",w.kind!=="npc");const r=ct("overlay-result"),o=r.classList.contains("hidden");if(r.classList.remove("hidden"),o){Vt.finalWhistle();const a=t.winner!=="draw"&&(t.winner==="black"?Se:sn)===w.myColor,c=t.winner==="draw"?"draw":a?"win":"lose";window.setTimeout(()=>Vt.result(c),1500)}}function Ug(i){if(!w)return;if(w.kind==="replay"){ce("再生モードでは打てません");return}const t=w.game;if(t.over||w.kind==="online"&&w.ended)return;if(w.kind==="npc"&&w.thinking){ce("NPCが思考中です");return}if(t.turn!==w.myColor){ce("あなたの番ではありません");return}const e=t.tryPlace(i);if(!e.ok){Vt.buzzer(),ce(ll(e.reason));return}if(w.kind==="npc"){const n=t.play(i);n.ok&&(Vt.stone(),n.captures.length>0&&Vt.capture(n.captures.length)),ze(),ei()}else w.ws.send(JSON.stringify({t:"move",p:i}))}function Ig(){if(!(!w||w.kind==="replay"||!Ys()))if(w.kind==="npc"){if(w.thinking)return;w.game.pass(),w.game.over||Vt.passWhistle(),ze(),ei()}else{if(w.ended)return;w.ws.send(JSON.stringify({t:"pass"}))}}function Ng(){if(!(!w||w.kind==="replay"||w.game.over))if(w.kind==="npc"){if(w.thinking){ce("NPCの思考中は待ったできません");return}w.game.undoFor(w.myColor)?(Vt.foul(),ce("待ったしました"),ze(),ei()):ce("戻せる着手がありません")}else{if(w.ended)return;w.ws.send(JSON.stringify({t:"undo"}))}}function Fg(){!w||w.kind==="replay"||w.game.over||w.kind==="online"&&w.ended||window.confirm("投了しますか？")&&(w.kind==="npc"?(w.game.resign(w.myColor),ze(),ei()):w.ws.send(JSON.stringify({t:"resign"})))}function Og(){if(!w||w.kind!=="npc")return;const i=w.game;if(i.over||i.turn===w.myColor)return;w.thinking=!0,ze();const t=ts(i.moveLog);w.pending=[];for(const e of w.workers)e.postMessage({t:"genmove",komi:i.komi,moves:t,timeMs:w.timeMs})}function ei(){if(!w||w.kind!=="npc")return;const i=w.game;if(!i.over&&i.turn!==w.myColor){Og();return}const t=i.over?{t:"stop"}:{t:"ponder",komi:i.komi,moves:ts(i.moveLog)};for(const e of w.workers)e.postMessage(t)}function Bg(i){const t=new Map;for(const o of i.pending)for(const a of o.children)t.set(a.move,(t.get(a.move)??0)+a.visits);if(i.pending=[],i.thinking=!1,i.game.over)return;let e=-1,n=-1;for(const[o,a]of t)a>n&&(n=a,e=o);const s=i.myColor===Se?sn:Se;let r=!1;if(e>=0){const o=i.game.play(e);o.ok&&(r=!0,Vt.stone(),o.captures.length>0&&Vt.capture(o.captures.length))}r||(i.game.pass(),ce(`NPC（${Ze(s)}）がパスしました`),i.game.over||Vt.passWhistle()),ze(),ei()}function kg(i,t,e){const n=t==="random"?Math.random()<.5?Se:sn:t==="black"?Se:sn,s=Math.max(1,Math.min(4,(navigator.hardwareConcurrency||4)-1)),r=[],o={kind:"npc",game:new Ni(i),myColor:n,workers:r,pending:[],thinking:!1,timeMs:e};for(let a=0;a<s;a++){const c=new Worker(new URL("/assets/npcWorker-BHHn1t9F.js",import.meta.url),{type:"module"});c.onmessage=l=>{if(w!==o||!o.thinking)return;const h=l.data;h.t==="move"&&(o.pending.push({sims:h.sims,children:h.children}),o.pending.length>=o.workers.length&&Bg(o))},r.push(c)}w=o,na(),ct("room-line").classList.add("hidden"),ce(`あなたは${Ze(n)}番です`,2500),Vt.kickoff(),ei()}let Xn=null;function zg(){return`${location.protocol==="https:"?"wss":"ws"}://${location.host}/ws`}function fn(i){ct("online-status").innerHTML=i}function hl(i){Xn&&(Xn.close(),Xn=null),fn("サーバーに接続中…");const t=new WebSocket(zg());Xn=t,t.onopen=()=>t.send(JSON.stringify(i)),t.onmessage=e=>{const n=JSON.parse(e.data);switch(n.t){case"created":fn(`部屋コード<span class="room-code">${n.room}</span>このコードを相手に伝えてください。参加を待っています…`);break;case"start":{Xn=null;const s={kind:"online",game:new Ni(n.komi),myColor:n.color,ws:t,komi:n.komi,room:n.room,undoCounts:{1:0,2:0},prevLogLen:0,ended:!1,leaving:!1};w=s,fn(""),na();const r=ct("room-line");r.textContent=`部屋: ${n.room}`,r.classList.remove("hidden"),ce(`対局開始！ あなたは${Ze(s.myColor)}番です`,3e3),Vt.kickoff(),ze();break}case"state":Gg(n);break;case"illegal":Vt.buzzer(),n.reason==="undo"?ce("戻せる着手がありません"):n.reason==="notyourturn"?ce("あなたの番ではありません"):ce(ll(n.reason));break;case"undone":(w==null?void 0:w.kind)==="online"&&n.by!==w.myColor?ce("相手が待ったをしました"):ce("待ったしました");break;case"opponentLeft":(w==null?void 0:w.kind)==="online"&&w.ws===t&&(w.ended=!0,ce("相手が退出しました"),ze());break;case"error":ce(String(n.msg)),fn(String(n.msg));break}},t.onclose=()=>{Xn===t&&(Xn=null,fn("サーバーとの接続が切れました")),(w==null?void 0:w.kind)==="online"&&w.ws===t&&!w.leaving&&!w.ended&&(w.ended=!0,ce("サーバーとの接続が切れました"),ze())},t.onerror=()=>{fn("接続エラー：サーバーに接続できません")}}function Gg(i){if(!w||w.kind!=="online")return;const t=new Ni(w.komi);for(const e of i.log)e.type==="pass"?t.pass():e.type==="resign"?t.resign(e.by):t.play(e.point);if(i.log.length>w.prevLogLen){const e=i.log[i.log.length-1];e.type==="pass"?t.over||(Vt.passWhistle(),ce(`${Ze(e.by)}がパスしました`)):e.type==="move"&&(Vt.stone(),e.captures&&e.captures.length>0&&Vt.capture(e.captures.length))}else i.log.length<w.prevLogLen&&Vt.foul();w.prevLogLen=i.log.length,w.game=t,w.undoCounts=i.undoCounts,ze()}function ul(i,t,e){const n=new Ni(i);for(let s=0;s<e;s++)al(n,t[s]);return n}function dl(i,t,e){pl(),w={kind:"replay",komi:i,moves:t,cursor:e,game:ul(i,t,e)},ct("overlay-result").classList.add("hidden"),na(),ct("room-line").classList.add("hidden")}function Pn(i){if(!w||w.kind!=="replay")return;const t=Math.max(0,Math.min(w.moves.length,i));if(t===w.cursor)return;const e=t>w.cursor;w.cursor=t,w.game=ul(w.komi,w.moves,t),e&&w.moves[t-1]<Jo?Vt.stone(!0):Vt.tick(),ze()}function fl(i,t){return`${location.origin}${location.pathname}?kifu=${Sg(i,t)}`}const Hg={600:"初級",1800:"中級",4e3:"上級",8e3:"最強"};function Vg(){if(!w||w.kind==="replay"||!w.game.over)return null;const i=w.game,t=i.score(),e=w.kind==="npc"?`NPC（${Hg[w.timeMs]??"？"}）`:"オンライン対戦";let n;if(t.winner==="draw")n=w.kind==="npc"?`${e}と持碁（引き分け）`:`${e}で持碁（引き分け）`;else{const r=(t.winner==="black"?Se:sn)===w.myColor,o=t.byResign!==void 0?"中押し":`${Math.abs(t.margin)}目`,a=r?`${o}勝ち！`:`${o}負け…`;n=w.kind==="npc"?`${e}に${a}`:`${e}で${a}`}const s=t.byResign!==void 0?"":`（黒${t.black}子・白${t.white}子${i.komi!==0?`＋コミ${i.komi}`:""}）`;return`球面で打つ囲碁「囲碁サッカー」⚽ ${n}${s} #囲碁サッカー`}function Wg(){const i=Vg();if(!i||!w||w.kind==="replay")return null;const t=ts(w.game.moveLog),e=t.length>0?fl(w.game.komi,t):`${location.origin}${location.pathname}`;return{text:i,url:e}}function ea(i){const t=Wg();if(!t)return;const e=i(t);e&&window.open(e,"_blank","noopener,noreferrer")}function Xg(){ea(i=>`https://x.com/intent/post?text=${encodeURIComponent(`${i.text}
`)}&url=${encodeURIComponent(i.url)}`)}function qg(){ea(i=>`https://misskey-hub.net/share/?text=${encodeURIComponent(i.text)}&url=${encodeURIComponent(i.url)}&visibility=public`)}const bc="gofb-mastodon-host";function Yg(){ea(i=>{const t=localStorage.getItem(bc)||"mastodon.social",e=window.prompt("あなたのMastodonサーバー名を入力してください（例: mastodon.social）",t);if(e===null)return null;const n=e.trim().replace(/^https?:\/\//,"").replace(/\/.*$/,"");return n?(localStorage.setItem(bc,n),`https://${n}/share?text=${encodeURIComponent(`${i.text}
${i.url}`)}`):null})}async function Uo(i,t){if(t.length===0){ce("まだ着手がありません");return}const e=fl(i,t);try{await navigator.clipboard.writeText(e),ce("棋譜URLをコピーしました")}catch{window.prompt("コピーできませんでした。以下のURLを手動でコピーしてください:",e)}}function na(){ta("game"),Lg(),tn.resetView(),Vt.enterGame(),ze()}function pl(){if(w){if(w.kind==="npc")for(const i of w.workers)i.terminate();else w.kind==="online"&&(w.leaving=!0,w.ws.close());w=null}}function ml(){pl(),Vt.leaveGame(),fn(""),location.search&&history.replaceState(null,"",location.pathname),ta("title")}ct("btn-npc-start").addEventListener("click",()=>{const i=gl(ct("npc-komi").value),t=ct("npc-color").value,e=Number(ct("npc-level").value);kg(i,t,e)});ct("btn-create").addEventListener("click",()=>{const i=gl(ct("online-komi").value),t=ct("online-color").value;hl({t:"create",komi:i,color:t})});ct("btn-join").addEventListener("click",()=>{const i=ct("join-code").value.trim().toUpperCase();if(!i){fn("部屋コードを入力してください");return}hl({t:"join",room:i})});function gl(i){const t=parseFloat(i);return Number.isFinite(t)?t:0}ct("btn-pass").addEventListener("click",Ig);ct("btn-undo").addEventListener("click",Ng);ct("btn-resign").addEventListener("click",Fg);ct("btn-leave").addEventListener("click",()=>{w&&w.kind!=="replay"&&!w.game.over&&!window.confirm("対局を中断してタイトルへ戻りますか？")||ml()});ct("btn-result-title").addEventListener("click",ml);ct("btn-rematch").addEventListener("click",()=>{!w||w.kind!=="npc"||(ct("overlay-result").classList.add("hidden"),w.game=new Ni(w.game.komi),w.thinking=!1,w.pending=[],Vt.kickoff(),ze(),ei())});for(const i of document.querySelectorAll("#view-buttons button[data-view]"))i.addEventListener("click",()=>{tn==null||tn.viewPreset(i.dataset.view)});ct("btn-view-reset").addEventListener("click",()=>tn==null?void 0:tn.resetView());function ia(){const i=ct("btn-bgm"),t=ct("btn-se");i.textContent=`♪ BGM: ${Vt.bgmOn?"ON":"OFF"}`,t.textContent=`🔔 効果音: ${Vt.seOn?"ON":"OFF"}`,i.classList.toggle("off",!Vt.bgmOn),t.classList.toggle("off",!Vt.seOn)}ct("btn-bgm").addEventListener("click",()=>{Vt.setBgm(!Vt.bgmOn),ia()});ct("btn-se").addEventListener("click",()=>{Vt.setSe(!Vt.seOn),ia(),Vt.seOn&&Vt.stone(!0)});ia();ct("btn-review").addEventListener("click",()=>{if(!w||w.kind==="replay")return;const i=w.game.komi,t=ts(w.game.moveLog);dl(i,t,t.length)});ct("btn-share-x").addEventListener("click",Xg);ct("btn-share-misskey").addEventListener("click",qg);ct("btn-share-mastodon").addEventListener("click",Yg);ct("btn-kifu-copy").addEventListener("click",()=>{w&&(w.kind==="replay"?Uo(w.komi,w.moves):Uo(w.game.komi,ts(w.game.moveLog)))});ct("btn-rp-copy").addEventListener("click",()=>{(w==null?void 0:w.kind)==="replay"&&Uo(w.komi,w.moves)});ct("btn-rp-first").addEventListener("click",()=>Pn(0));ct("btn-rp-prev").addEventListener("click",()=>{(w==null?void 0:w.kind)==="replay"&&Pn(w.cursor-1)});ct("btn-rp-next").addEventListener("click",()=>{(w==null?void 0:w.kind)==="replay"&&Pn(w.cursor+1)});ct("btn-rp-last").addEventListener("click",()=>{(w==null?void 0:w.kind)==="replay"&&Pn(w.moves.length)});document.addEventListener("keydown",i=>{if((w==null?void 0:w.kind)==="replay")switch(i.key){case"ArrowLeft":Pn(w.cursor-1),i.preventDefault();break;case"ArrowRight":Pn(w.cursor+1),i.preventDefault();break;case"Home":Pn(0),i.preventDefault();break;case"End":Pn(w.moves.length),i.preventDefault();break}});function $g(){const i=new URLSearchParams(location.search).get("kifu");if(!i)return!1;const t=yg(i);return t&&Eg(t)!==null?(dl(t.komi,t.moves,0),!0):(fn("棋譜URLの読み込みに失敗しました（URLが不正です）"),history.replaceState(null,"",location.pathname),!1)}const _l=$g();_l||ta("title");Pg({firstVisitPrompt:!_l});
